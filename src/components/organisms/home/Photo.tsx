...
const blackSignature =
  'https://res.cloudinary.com/dwrurydlt/image/upload/f_auto,q_auto,w_250/v1693066829/signature_b64d54de16.webp';
const whiteSignature =
  'https://res.cloudinary.com/dwrurydlt/image/upload/f_auto,q_auto,w_250/v1693556940/signature_white_60dbdcd21f.webp';
    ...
    <div className='flex h-[300px] w-full justify-center items-center lg:h-[280px] lg:w-1/2 lg:justify-end mt-0 md:mt-8 rounded-md'>
      <div className='flex flex-col items-center mb-2'>
        <img
          ...
          src='https://res.cloudinary.com/dwrurydlt/image/upload/f_auto,q_auto,w_190/v1694699676/avatar_md_nobg_ef5553f75b.png'
          alt='Avatar'
          width={190}
          style={{ height: '190px' }}
        />
